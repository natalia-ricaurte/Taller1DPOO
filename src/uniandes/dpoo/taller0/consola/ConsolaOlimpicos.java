...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país del atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * 
	 * Le pide ingresar el nombredel atleta de interes
	 * le muestra a el usuario el país del atleta entrado por parámetro
	 * 
	 */
	private void ejecutarPaisAtleta() 
	{
		...
		Map<String, String> pais = calculadora.paisDelAtleta(atleta);
		
		if (atleta != null)
			
		{
			
			String paisDelAtleta = pais.get(atleta);
		
			if( paisDelAtleta == null)
			{
				
				System.out.println("\n"+ "No existe información de este atleta");
				
			}
			else
			{
				
				System.out.println("\n"+ "El país del atleta "+ atleta + " es " + paisDelAtleta);
