...
public class CalculadoraEstadisticas
{
	...
	/**
	 * 
	 * Calcula cuál es el país que el atleta representa
	 * 
	 * @param nombre del atleta que se quiere consultar
	 * @return Un mapa donde las llaves son los nombres de los atletas y 
	 * 			los nombres de los países.
	 * 
	 * 			Si el atleta no existe en la base de datos retorna null,
	 * 			en caso de existir retorna el nombre del país que representa el atlera.
	 * 
	 */
	public Map <String, String> paisDelAtleta(String nombreAtleta)
	{
		...
		if (elAtleta != null)
		{
			...
			resultado.put(elAtleta.darNombre(),paisAtleta.darNombre());
